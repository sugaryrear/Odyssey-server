...
public class Misc {
	public static String[][] wordsletters = { //
			{"0", "zero"}, {"1","one"}, {"2", "two"}, {"3","three"},{"4","four"},{"5","five"},{"6","six"}, {"7","seven"}, {"8","eight"}, {"9","nine"},
	};
	public static String numberToWord(int number){
		String thenumber = "";
		for (int i = 0; i < wordsletters.length; i++) {
			if (wordsletters[i][0].contains(Integer.toString(number))) {
				thenumber = wordsletters[i][1];
			}
		}
		return thenumber;
	}
	...
	/**
	 * for all timers that give you a message of 'you have so and so time left' before you can do something'
	 * @param timeleft
	 * @return
	 */
	...
	public static String howMuchTimeLeft_dailytask(long timeleft) {
		int Millis = (int) timeleft;
		String s = String.format("%d hours %d minutes", Millis/(1000*60*60), (Millis%(1000*60*60))/(1000*60));
		return s;
	}

	public static String howMuchTimeLeft_teleint(long timeleft) {
		int Millis = (int) timeleft;
		String s = String.format("You have %d seconds",  ((Millis%(1000*60*60))%(1000*60))/1000);
		return s;
	}
	 ...
	 * @param chance The chance of rolling lucky islucky(75) = you have 75% chance to do something
