...
public class TreasureTrailsRewards {
	...
	public static List<TreasureTrailsRewardItem> getRandomRewards(RewardLevel difficulty, int rolls) {
		...
		if (difficulty == RewardLevel.MEDIUM) {
			...
			rolls += 2;
		} else if (difficulty == RewardLevel.TEAL) {
			rolls += 2;
		} else if (difficulty == RewardLevel.RED) {
			rolls += 2;
		}
	...
	public static List<TreasureTrailsRewardItem> getRewardsForType(int type) {
		...
		case 4:
			...
			break;
		case 5:
			level = RewardLevel.TEAL;
			break;
		case 6:
			level = RewardLevel.RED;
			break;
		}
...
//		add(new TreasureTrailsRewardItem(Items.COINS, 2500, 50000, RewardRarity.COMMON), RewardLevel.SHARED);
 ...
 ///// teal aod chest
		add(new TreasureTrailsRewardItem(Items.BANDOS_CHESTPLATE, 1, 1, RewardRarity.COMMON), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.BANDOS_TASSETS, 1, 1, RewardRarity.COMMON), RewardLevel.TEAL);

		add(new TreasureTrailsRewardItem(Items.TORVA_FULLHELM, 1, 1, RewardRarity.UNCOMMON), RewardLevel.TEAL);

		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_HELM, 1, 1, RewardRarity.RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_BODY, 1, 1, RewardRarity.RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_LEGS, 1, 1, RewardRarity.RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_GLOVES, 1, 1, RewardRarity.RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_BOOTS, 1, 1, RewardRarity.RARE), RewardLevel.TEAL);

		add(new TreasureTrailsRewardItem(Items.TEAL_AOD_CAPE, 1, 1, RewardRarity.VERY_RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.AOD_GOD_SWORD, 1, 1, RewardRarity.VERY_RARE), RewardLevel.TEAL);
		add(new TreasureTrailsRewardItem(Items.DEATHSTALKER_GODSWORD, 1, 1, RewardRarity.VERY_RARE), RewardLevel.TEAL);

		// red chest
		add(new TreasureTrailsRewardItem(Items.RED_AOD_BOOTS, 1, 1, RewardRarity.COMMON), RewardLevel.RED);
		add(new TreasureTrailsRewardItem(Items.RED_AOD_GLOVES, 1, 1, RewardRarity.COMMON), RewardLevel.RED);

		add(new TreasureTrailsRewardItem(Items.RED_AOD_BODY, 1, 1, RewardRarity.UNCOMMON), RewardLevel.RED);
		add(new TreasureTrailsRewardItem(Items.RED_AOD_LEGS, 1, 1, RewardRarity.UNCOMMON), RewardLevel.RED);

		add(new TreasureTrailsRewardItem(Items.RED_AOD_BOOTS, 1, 1, RewardRarity.RARE), RewardLevel.RED);
		add(new TreasureTrailsRewardItem(Items.RED_AOD_CAPE, 1, 1, RewardRarity.RARE), RewardLevel.RED);

		add(new TreasureTrailsRewardItem(Items.AOD_GOD_SWORD, 1, 1, RewardRarity.VERY_RARE), RewardLevel.RED);
		add(new TreasureTrailsRewardItem(Items.DEATHSTALKER_GODSWORD, 1, 1, RewardRarity.VERY_RARE), RewardLevel.RED);
	}
}
