...
import io.Odyssey.content.minigames.barrows.brothers.*;
...
//        System.out.println("here. "+pos);
     ...
     */
    void drainPrayer() {
        int newPrayer = player.playerLevel[5] - (8 + countDeadBrothers());
        player.playerLevel[5] = Integer.max(0, newPrayer);
...
//    }
    ...
    private void giveRewards(RewardList rewardList) {
        ...
        int gotBarrows = 0;
        int spot = 0;
        player.getPA().showInterface(85400);
