...
public abstract class TombsOfAmascutRoom {

    public abstract TombsOfAmascutBoss spawn(InstancedArea instancedArea);
    ...
    public GlobalObject getFoodChest(Position position, int face) {
        return new GlobalObject(TombsOfAmascutConstants.FOOD_CHEST_OBJECT_ID, position, face, 10);
    }
}
