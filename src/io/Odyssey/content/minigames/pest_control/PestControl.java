...
public class PestControl {
	...
	static {
		...
		items.put(LootRarity.RARE, Arrays.asList(
				new GameItem(Items.VOID_KNIGHT_MACE),
				new GameItem(Items.VOID_KNIGHT_TOP),
				new GameItem(Items.VOID_KNIGHT_ROBE),
		new GameItem(Items.VOID_KNIGHT_GLOVES),
				new GameItem(Items.VOID_MAGE_HELM),
				new GameItem(Items.VOID_MELEE_HELM),
				new GameItem(Items.VOID_SEAL8),
				new GameItem(Items.ELITE_VOID_TOP),
				new GameItem(Items.VOID_RANGER_HELM),
				new GameItem(Items.ELITE_VOID_ROBE)
	...
	private static final int POINT_REWARD = 75;
	...
	public static void addToLobby(Player player) {
		...
		if (player.combatLevel < 40) {
			player.sendMessage("You need a combat level of at least 40 to join.");
			return;
		}
