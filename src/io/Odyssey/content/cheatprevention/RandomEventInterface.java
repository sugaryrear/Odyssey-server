...
//			return;
//		}
		//fuck it add the resourcebox here


			player.randomeventLength = (int) Configuration.RANDOM_EVENT_LENGTH;
			player.randomeventDelay = System.currentTimeMillis();
			player.getGenie().spawnGenie();
...
//		CycleEventHandler.getSingleton().addEvent(this, this, 1);
	...
	//	long timeleft = System.currentTimeMillis() - player.randomeventDelay;
	//	long realtimeleft = player.randomeventLength - timeleft;

		if ((System.currentTimeMillis() - player.randomeventDelay < player.randomeventLength)) {
