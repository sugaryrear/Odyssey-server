...
public abstract class PartyInterface {
    ...
    public static void open(Player player) {
      ...
      // player.setSidebarInterface(13, INTERFACE_ID);
        player.getPA().sendInterfaceHidden(0, INTERFACE_ID);
        updateInterface(player);
    }

    public static void close(Player player) {
    //    player.setSidebarInterface(13, 962);//todo: we need to put the "group" into the clan chat tab.
        player.getPA().sendInterfaceHidden(1, INTERFACE_ID);
    }
