...
public class ModeSelection {
    ...
    private static final int CONFIRM_BUTTON = 165179;
    private static final int SCROLLABLE_CONTAINER = 24_308;
    public static final int INTERFACE_ID = 42400;
    ...
    //    player.getPA().showInterface(INTERFACE_ID);
        player.getPA().sendFrame248(INTERFACE_ID, 3213);
    }
...
//            return false;
    ...
    private enum Button {
        STANDARD(ModeType.STANDARD, 165183),//0
        ROGUE(ModeType.ROGUE, 94_248),
        IRONMAN(ModeType.IRON_MAN, 165162),
        HARDCORE_IRONMAN(ModeType.HC_IRON_MAN, 165163),
        ULTIMATE_IRONMAN(ModeType.ULTIMATE_IRON_MAN, 165165),
        ROGUE_HARDCORE_IRONMAN(ModeType.ROGUE_HARDCORE_IRONMAN, 95_004),
        GROUP_IRONMAN(ModeType.GROUP_IRONMAN, 167137),
        ;
