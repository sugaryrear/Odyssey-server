...
public class RangeData {
	...
	public static final int[] BOWS = {9705,19481, 19478, 12788, 9185, 11785, 21012, 839, 845, 847, 851, 855, 859, 841, 843, 849,
			853, 857, 12424, 861, 4212, 4214, 4215, 12765, 12766, 12767, 12768, 11235, 4216, 4217, 4218, 4219, 4220,
			4221, 4222, 4223, 4734, Items.AK_47, 6724, 20997, 21902, 26374, 25865, 25865, 22550, 27655, 25867, 25884, 25886, 25888, 25890, 25892, 29988, 29985,30051};

	public static final int[] ARROWS = {9706, 9341, 4160, 11959, 10033, 10034, 882, 883, 884, 885, 886, 887, 888, 889, 890, 891,
			892, 893, 4740,Items.BULLETS_769x39,5616, 5617, 5618, 5619, 5620, 5621, 5622, 5623, 5624, 5625, 5626, 5627, 9139, 9140, 9141,
	...
	public static final int[] NO_ARROW_DROP = {11959, 10033, 10034, 4212, 22550, 27655, 4214, 4215, 4216, 4217, 4218, 4219, 4220, 4221,
			4222, 4223, 4734, Items.AK_47,4934, 4935, 4936, 4937,27655, 22550,};
...
//				
				...
				// CRYSTAL_BOW
				{4212, 250}, {25865, 1925}, {4214, 250}, {27655, 2354}, {22550, 250}, {4215, 250}, {4216, 250}, {4217, 250}, {4218, 250}, {4219, 250}, {4220, 250}, {4221, 250}, {4222, 250},
				{4223, 250}, {25867, 1923}, {29988, 2206},{30051, 2030}, {29985, 2206},  {25884, 1925}, {25886, 1927}, {25888, 1929}, {25890, 1931}, {25892, 1933},


				// ARROWS
				{882, 19}, {9706, 19},{884, 18}, {886, 20}, {888, 21}, {890, 22}, {892, 24}, {11212, 1120}, {21326, 1385},
		...
		if (c.attacking.getRangedWeaponType() == RangedWeaponType.DOUBLE_SHOT) {
			...
			int[][] moreD = {{882, 1104}, {9706, 1104},{884, 1105}, {886, 1106}, {888, 1107}, {890, 1108}, {892, 1109}, {11212, 1111}, {21326, 1383}};
	...
	public static int getRangeProjectileGFX(Player c) {
		...
		int[][] data = {
				...
				// ARROWS
				{882, 19},	{9706, 19}, {884, 18}, {886, 20}, {888, 21}, {890, 22},{892, 24}, {11212, 1120}, {21326, 1384},

				// CHINCHOMPA
				{10033, 908}, {10034, 909}, {11959, 909},

				// OTHERS
				{6522, 442}, {4740, 27},{Items.BULLETS_769x39, 27},{Items.AK_47, 27}, {4212, 249}, {4214, 249}, {27655, 2354}, {22550, 249}, {4215, 249}, {4216, 249}, {4217, 249}, {4218, 249}, {4219, 249}, {4220, 249}, {4221, 249},
				{4222, 249}, {4223, 249}, {29988, 2206},{ 30051, 2030}, {29985, 2206}, {25884, 1925}, {25886, 1927}, {25888, 1929}, {25890, 1931}, {25892, 1933}, {25865, 1925},};
		for (int l = 0; l < data.length; l++) {
