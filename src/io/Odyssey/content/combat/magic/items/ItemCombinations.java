...
import io.Odyssey.content.combat.magic.items.item_combinations.*;
...
public enum ItemCombinations {
	...
	FROZEN_KEY(new FrozenKey(new GameItem(26356), Optional.empty(),
			new GameItem[] { new GameItem(26358), new GameItem(26362), new GameItem(26364), new GameItem(26360) })),
	;
