...
import io.Odyssey.model.cycleevent.impl.curses.*;
				...
				switch (i) {
					...
					case 23:
						if (Boundary.isIn(c, Boundary.RFD)) {
							//resetPrayers(c);
							c.sendMessage("@red@The culinaromancer's dimension blocks all protection prayers!");
							return;
						}
						headIcon = true;
						for (int p = 16; p < 24; p++) {
