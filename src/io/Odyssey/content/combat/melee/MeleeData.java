...
public class MeleeData {
	...
	public static void setWeaponAnimations(Player c) {
		...
		if (weaponName.contains("wand") || (weaponName.contains("staff") && !weaponName.contains("zamorak")  && !weaponName.contains("guthix")  && !weaponName.contains("saradomin")) || weaponName.contains("trident")) {
			c.playerStandIndex = 809;
			c.playerRunIndex = 1210;
			c.playerWalkIndex = 1146;
			return;
