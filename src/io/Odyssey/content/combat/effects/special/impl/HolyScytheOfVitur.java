 ...
 */
public class HolyScytheOfVitur implements SpecialEffect {

    public static HolyScytheOfVitur SCYTHE_EFFECT = new HolyScytheOfVitur();

    public static boolean usingScythe(Player player) {
        return player.getItems().isWearingItem(Items.HOLY_SCYTHE_OF_VITUR, Player.playerWeapon);
    }

    @Override
    public boolean activateSpecialEffect(Player player, Object... args) {
        boolean usingScythe = player.getItems().isWearingItem(Items.HOLY_SCYTHE_OF_VITUR, Player.playerWeapon);
