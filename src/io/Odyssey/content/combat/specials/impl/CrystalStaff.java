...
public class CrystalStaff extends Special {

    public CrystalStaff() {
        super(5.0, 1.0, 1.0, new int[] { 23900 });
    }

    public static final Graphic CRYSTALSTAFF = new Graphic(1761);
    ...
    public void activate(Player player, Entity target, Damage damage) {
        ...
        player.gfx0(1769);
        target.startGraphic(new Graphic(1769));
        Server.getEventHandler().stop(player, "crystal_staff_perfected");
