...
public class SecondSpecialHit extends Special {
    ...
    public static SecondSpecialHit HAND_CANNON_2 = new SecondSpecialHit(0, 1.43, 1.00, new int[] { 30051 });

    public static SecondSpecialHit ANCIENT_GODSWORD_HIT_2 = new SecondSpecialHit(0, 1.43, 1.00, new int[] { 26233, 26_233 });
    /**
