package io.Odyssey.content.combat.specials;
...
public enum Specials {
	...
	ANCIENT_GODSWORD(new AnicentGodSword()),
	...
	CRYSTAL_STAFF(new CrystalStaff()),
	...
	OSMUMTENS_FANG(new OsmumtensFang()),
	KORASI_SWORD(new KorasiSword()),
	BATTLE_HARDENDED_KORASI(new BattleHardenedKorasi()),
	AOD_GOD_SWORD(new AodGodSword()),
	HAND_CANNON(new HandCannon()),
	VOID_WALKER(new VoidWalker()),
	WEBWEAVER_BOW(new WebweaverBow()),
	URASINE_CHAIN_MACE(new UrasineChainMace()),
	;
