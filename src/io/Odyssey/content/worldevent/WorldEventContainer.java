...
public class WorldEventContainer {
    ...
    public static final List<WorldEvent> WORLD_EVENT_LIST = Collections.unmodifiableList(Lists.newArrayList(new TournamentWorldEvent()));
    ...
    public void initialise() throws IOException {
        if (Server.isDebug() || Server.isTest()) {
            cyclesBetweenEvents = Misc.toCycles(2, TimeUnit.MINUTES);
        } else {
