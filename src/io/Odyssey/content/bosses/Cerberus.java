...
public class Cerberus extends LegacySoloPlayerInstance {
	...
	public final void end(DisposeTypes dispose) {
		...
		Server.getGlobalObjects().remove(new GlobalObject(23105, 1241, 1242, getHeight(), 0, 10).setInstance(this));
		Server.getGlobalObjects().remove(new GlobalObject(23105, 1240, 1242, getHeight(), 0, 10).setInstance(this));
		Server.getGlobalObjects().remove(new GlobalObject(23105, 1239, 1242, getHeight(), 0, 10).setInstance(this));
		Server.getGlobalObjects().remove(new GlobalObject(23105, 1240, 1236, getHeight(), 0, 10).setInstance(this));
	}
