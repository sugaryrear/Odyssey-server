...
public class Skotizo extends LegacySoloPlayerInstance {
	 ...
	 */
	private static final int START_X = 2270, START_Y = 5663;
	
	/**
	 * Npc variables, start coordinates.
	 */
	public static final int SPAWN_X = 2268,
			SPAWN_Y = 5659,
			SKOTIZO_ID = 7286,
			...
			while (!unique) {
				...
				if(altar == null) {
					...
					if (ALTAR_MAP_DIRECTION[altarNumber-1] == "NORTH") {
						...
						Server.getGlobalObjects().remove(28924,  2270,5672, getHeight(), this); // Remove North - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923,  2270,5672, getHeight(), 2, 10, -1, -1).setInstance(this)); // North - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_NORTH,  2270,5672, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						northAltar = true;
						...
						Server.getGlobalObjects().remove(28924, 2271,5652, getHeight(), this); // Remove South - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2271,5652, getHeight(), 0, 10, -1, -1).setInstance(this)); // South - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_SOUTH, 2271,5652, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						southAltar = true;
						...
						Server.getGlobalObjects().remove(28924, 2260,5663, getHeight(), this); // Remove West - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923, 2260,5663, getHeight(), 1, 10, -1, -1).setInstance(this)); // West - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_WEST, 2260,5663, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						westAltar = true;
						...
						Server.getGlobalObjects().remove(28924,  2283,5662, getHeight(), this); // Remove East - Empty Altar
						Server.getGlobalObjects().add(new GlobalObject(28923,  2283,5662, getHeight(), 3, 10, -1, -1).setInstance(this)); // East - Awakened Altar
						add(NPCSpawning.spawnNpcOld(player, AWAKENED_ALTAR_EAST,  2283,5662, getHeight(), 0, 100, 10, 200, 200, false, false));
						altarCount++;
						eastAltar = true;
					}
				} else {
	...
	public void init() {
		...
		Server.getGlobalObjects().add(new GlobalObject(28924, 2271,5652, getHeight(), 0, 10, -1, -1).setInstance(this)); // South - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2270,5672, getHeight(), 2, 10, -1, -1).setInstance(this)); // North - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2260,5663, getHeight(), 1, 10, -1, -1).setInstance(this)); // West - Empty Altar
		Server.getGlobalObjects().add(new GlobalObject(28924, 2283,5662, getHeight(), 3, 10, -1, -1).setInstance(this)); // East - Empty Altar
	}
	...
	public final void end() {
		...
		if (northAltar) {
			NPCHandler.kill(AWAKENED_ALTAR_NORTH, getHeight());
			Server.getGlobalObjects().remove(28923, 2270,5672, getHeight()); // Remove North - Awakened Altar
			Server.getGlobalObjects().add(new GlobalObject(28924, 2270,5672, getHeight(), 2, 10, -1, -1)); // Add North - Empty Altar
			player.getPA().sendChangeSprite(29232, (byte) 0);
			altarMap.remove(1);
			northAltar = false;
		} else {
			Server.getGlobalObjects().remove(28924, 2270,5672, getHeight()); // Remove North - Empty Altar
		}
		if (southAltar) {
			NPCHandler.kill(AWAKENED_ALTAR_SOUTH, getHeight());
			Server.getGlobalObjects().remove(28923, 2271,5652, getHeight()); // Remove South - Awakened Altar
			Server.getGlobalObjects().add(new GlobalObject(28924, 2271,5652, getHeight(), 0, 10, -1, -1)); // Add South - Empty Altar
			player.getPA().sendChangeSprite(29233, (byte) 0);
			altarMap.remove(2);
			southAltar = false;
		} else {
			Server.getGlobalObjects().remove(28924, 2271,5652, getHeight()); // Remove South - Empty Altar
		}
		if (westAltar) {
			NPCHandler.kill(AWAKENED_ALTAR_WEST, getHeight());
			Server.getGlobalObjects().remove(28923, 2260,5663, getHeight()); // Remove West - Awakened Altar
			Server.getGlobalObjects().add(new GlobalObject(2260,5663, 9888, getHeight(), 1, 10, -1, -1)); // Add West - Empty Altar
			player.getPA().sendChangeSprite(29234, (byte) 0);
			altarMap.remove(3);
			westAltar = false;
		} else {
			Server.getGlobalObjects().remove(28924, 2260,5663, getHeight()); // Remove West - Empty Altar
		}
		if (eastAltar) {
			NPCHandler.kill(AWAKENED_ALTAR_EAST, getHeight());
			Server.getGlobalObjects().remove(28923, 2283,5662, getHeight()); // Remove East - Awakened Altar
			Server.getGlobalObjects().add(new GlobalObject(28924, 2283,5662, getHeight(), 3, 10, -1, -1)); // Add East - Empty Altar
			player.getPA().sendChangeSprite(29235, (byte) 0);
			altarMap.remove(4);
			eastAltar = false;
		} else {
			Server.getGlobalObjects().remove(28924, 2283,5662, getHeight()); // Remove East - Empty Altar
		}
		if (demonsSpawned) {
