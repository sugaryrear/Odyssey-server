...
public class SarachnisNpc extends NPC {
    ...
    public static final Position SPAWN_POSITION = new Position(1842, 9901, 0);
    ...
    public void process() {
        try {
            if (this.getNpcId() == Npcs.SARACHNIS) {
                ...
                if (nextWalk != null) {//so this is how you make an npc move somewhere properly.
                    if (getPosition().getX() == nextWalk.getX() && getPosition().getY() == nextWalk.getY()){//(thats why walking didnt work. must use it as this not equals.
                        nextWalk = null;
