...
public enum HydraStage {
    POISON(8615, 8616, 9111, -1, 1100, new Boundary(1368, 10260, 1374, 10266)),
    LIGHTNING(8619, 8617, 9111, 8238, 825, new Boundary(1368, 10269, 1374, 10275)),
    FLAME(8620, 8618, 9111, 8245, 550, new Boundary(1359, 10269, 1365, 10275)),
    ENRAGED(8621, 8622, 9111, 8252, 275, AlchemicalHydra.AREA);
