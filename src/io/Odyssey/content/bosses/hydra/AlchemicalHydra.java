...
//        }
    ...
    player.getPA().movePlayerUnconditionally(1356, player.getY(), getHeight());

      //  player.removeFromInstance();
        add(player);
        currentStage = HydraStage.POISON;
        npc = NPCSpawning.spawnNpc(this, currentStage.getNpcId(), CENTER.getX(), CENTER.getY(), getHeight(), 0, 55);
        add(npc);
