...
public class Achievements {
    ...
    public enum Achievement {
        ...
        LONE_SURVIVOR("Lone Survivor Noob", 0, AchievementTier.STARTER, AchievementType.TOURNAMENT, "Enter %d Lone Surviver\\nTournaments", 1, 0, new GameItem(995, 500000)),
        ...
        AvatarOfCreation("Hello AvatarOfCreation", 3, AchievementTier.STARTER, AchievementType.AvatarOfCreation, "Finish %d AvatarOfCreation\\nEvent", 1, 0, new GameItem(21046, 2)),
        ...
        COMPETITOR(25, AchievementTier.TIER_1, AchievementType.TOURNAMENT, "Enter %d Lone Survivor\\nTournaments", 5, 1, new GameItem(989, 1), new GameItem(11739, 1)),
        ...
        ADVANCED_VOTER("Democracy %d", 22, AchievementTier.TIER_2, AchievementType.VOTE_CHEST_UNLOCK, "Open %d Vote Chests", 2, 2, new GameItem(29981, 1), new GameItem(11739, 1)),
        /**
        ...
        EXTREME_VOTER("Democracy %d", 23, AchievementTier.TIER_3, AchievementType.VOTE_CHEST_UNLOCK, "Open %d Vote Chests", 5, 3, new GameItem(995, 10000000), new GameItem(11739, 2), new GameItem(29981, 2)),
        /**
         * Tier 4 Achievement Start
         */
        AVATAR_OF_CREATION( 2, AchievementTier.TIER_4, AchievementType.AvatarOfCreation, "Finish %d AvatarOfCreation\\nEvents", 20, 4, new GameItem(22374, 8), new GameItem(995, 10000000)),
        ...
        THE_NIGHTMARE( 5, AchievementTier.TIER_4, AchievementType.NIGHTMARE, "Kill %d Nightmare", 100, 4, new GameItem(29980, 1), new GameItem(995, 10000000)),
        ALCHEMICAL_HYDRA( 6, AchievementTier.TIER_4, AchievementType.HYDRA, "Kill %d Hydra", 100, 4, new GameItem(29980, 1), new GameItem(995, 10000000)),
        MIMIC( 8, AchievementTier.TIER_4, AchievementType.MIMIC, "Kill %d Mimics", 20, 4, new GameItem(29981, 1), new GameItem(995, 10000000)),
        ...
        MAX( 11, AchievementTier.TIER_4, AchievementType.MAX, "Achieve level 99 in\\nall skills", 1, 4, new GameItem(29979, 1), new GameItem(691, 1), new GameItem(995, 20000000));
