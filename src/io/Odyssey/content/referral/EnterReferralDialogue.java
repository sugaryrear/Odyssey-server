...
public class EnterReferralDialogue extends DialogueBuilder {
    ...
    private static final List<GameItem> STANDARD_REWARD = Lists.newArrayList(new GameItem(6199, 1), new GameItem(995, 25000));
    private static final String PHRASE = "How did you hear about us?";

    public EnterReferralDialogue(Player player) {
        super(player);
        int totalReq = ( 22);
        setNpcId(Npcs.LUMBRIDGE_GUIDE);
        npc(PHRASE);
    ...
    private void standardReferral(Player player, ReferralSource source) {
        register(player, source, null, STANDARD_REWARD,"You receive a mystery box and some gold.");
    }
