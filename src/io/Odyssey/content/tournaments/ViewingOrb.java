...
public class ViewingOrb {
   ...
   public static void spectateTournament(Player c) {
    ...
    public static void kickSpectators() {
        PlayerHandler.nonNullStream().filter(p -> (Boundary.isIn(p, Boundary.LUMBRIDGE_OUTLAST_AREA) ||  Boundary.isIn(p, Boundary.LONE_SURVIVER_AREA)) && p.spectatingTournament)
