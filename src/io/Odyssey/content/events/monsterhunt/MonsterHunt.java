package io.Odyssey.content.events.monsterhunt;
...
public class MonsterHunt {
	...
	public enum Npcs {
		FRAGMENT_OF_SEREN(FragmentOfSeren.FRAGMENT_ID, "Seren", 7000, 30, 250, 250),
		UNBEARABLE(TheUnbearable.NPC_ID, "Unbearable", 7000, 55, 400, 350);
