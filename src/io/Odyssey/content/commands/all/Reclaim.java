...
import io.Odyssey.sql.donation.reclaim.ReclaimDonationResponse;
import io.Odyssey.sql.donation.reclaim.ReclaimQuery;
import io.Odyssey.util.Misc;
import io.Odyssey.util.logging.player.ReclaimDonationLog;
...
public class Reclaim extends Command {
	...
	public Optional<String> getDescription() {
		return Optional.of("Reclaim donations from Odyssey v1 between ");
	}
}
