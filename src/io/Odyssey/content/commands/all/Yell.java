...
import io.Odyssey.model.entity.player.RightGroup;
...
public class Yell extends Command {
	...
	public static String formatMessage(String title, String username, String color, String message) {
		if (title.equalsIgnoreCase("None") || title.length() == 0) {
			...
			title = "[<shad=2><col=" + color + ">" + title + "</shad></col>]";
		}
		return title + "<shad=2><col=" + color + ">" + username + "</shad></col>: " + StringUtils.capitalize(message.toLowerCase());
	}
