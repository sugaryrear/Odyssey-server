...
public class CommandManager {
    ...
    public static final List<CommandPackage> COMMAND_PACKAGES = Lists.newArrayList(new CommandPackage("admin", Right.ADMINISTRATOR), new CommandPackage("owner", Right.OWNER), new CommandPackage("moderator", Right.MODERATOR), new CommandPackage("helper", Right.HELPER),new CommandPackage("test", Right.MODERATOR), new CommandPackage("donator", Right.REGULAR_DONATOR), new CommandPackage("all", Right.PLAYER));
