	...
	public void execute(Player player, String commandName, String input) {
		switch (input) {
			...
			case "resetwildwarn":
				...
				break;
			case "arceeusbook":
				player.setSidebarInterface(6, 23100); // arceeus
				break;
			case "perdulost":
			...
			case "compreq":
				...
				break;
			case "consxp":
				player.getPA().addSkillXPMultiplied(8, Skill.CONSTRUCTION.getId(),
						true);
				break;
			case "openpc":
			PriceChecker.open(player);
				break;
			case "huntxp":
				player.getPA().addSkillXPMultiplied(8, Skill.HUNTER.getId(),
						true);
				break;
			case "skillset":
