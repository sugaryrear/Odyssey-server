...
public final class FremennikAchievementDiary extends StatefulAchievementDiary<FremennikDiaryEntry> {
	...
	public void updateDiary() {
		...
		player.fremennik_diary_done = (int) (easy_done() + med_done() + hard_done() + elite_done());
		player.fremennik_diary_total = (int)totalcompleted;
	}
	...
	public void display() {
		Set<FremennikDiaryEntry>  easy = getEasy();
		Set<FremennikDiaryEntry> medium = getMedium();
		Set<FremennikDiaryEntry>  hard = getHard();
		Set<FremennikDiaryEntry> elite = getElite();
		...
		player.getPA().sendFrame126("Fremennik Diary", 8144);
