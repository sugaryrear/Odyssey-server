...
public final class DesertAchievementDiary extends StatefulAchievementDiary<DesertDiaryEntry> {
	...
	public void updateDiary() {
		...
		player.desert_diary_done = (int) (easy_done() + med_done() + hard_done() + elite_done());
		player.desert_diary_total = (int)totalcompleted;
	}
	...
	public void display() {
		...
		Set<DesertDiaryEntry>  easy = getEasy();
		Set<DesertDiaryEntry> medium = getMedium();
		Set<DesertDiaryEntry> hard = getHard();
		Set<DesertDiaryEntry> elite = getElite();
		...
		player.getPA().sendFrame126("Desert Diary", 8144);
