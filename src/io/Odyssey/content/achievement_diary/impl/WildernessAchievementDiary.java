...
public final class WildernessAchievementDiary extends StatefulAchievementDiary<WildernessDiaryEntry> {
	...
	public void updateDiary() {
		...
		player.wild_diary_done = (int) (easy_done() + med_done() + hard_done() + elite_done());
		player.wild_diary_total = (int)totalcompleted;
	}
	...
	public void display() {
		Set<WildernessDiaryEntry>    easy = getEasy();
		Set<WildernessDiaryEntry>   medium = getMedium();
		Set<WildernessDiaryEntry>    hard = getHard();
		Set<WildernessDiaryEntry>   elite = getElite();
		...
		player.getPA().sendFrame126("Wilderness Diary", 8144);
