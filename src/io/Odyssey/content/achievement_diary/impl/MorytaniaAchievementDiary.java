...
public final class MorytaniaAchievementDiary extends StatefulAchievementDiary<MorytaniaDiaryEntry> {
	...
	public void updateDiary() {
		...
		player.morytania_diary_done = (int) (easy_done() + med_done() + hard_done() + elite_done());
		player.morytania_diary_total = (int)totalcompleted;
	}
	...
	public void display() {
		Set<MorytaniaDiaryEntry>   easy = getEasy();
		Set<MorytaniaDiaryEntry> medium = getMedium();
		Set<MorytaniaDiaryEntry>   hard = getHard();
		Set<MorytaniaDiaryEntry> elite = getElite();
		...
		player.getPA().sendFrame126("Morytania Diary", 8144);
