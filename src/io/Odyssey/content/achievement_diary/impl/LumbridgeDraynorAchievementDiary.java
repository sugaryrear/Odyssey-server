...
public final class LumbridgeDraynorAchievementDiary extends StatefulAchievementDiary<LumbridgeDraynorDiaryEntry> {
	...
	public void updateDiary() {
		...
		player.lumb_diary_done = (int) (easy_done() + med_done() + hard_done() + elite_done());
		player.lumb_diary_total = (int)totalcompleted;
	}
	...
	public void display() {
		Set<LumbridgeDraynorDiaryEntry>   easy = getEasy();
		Set<LumbridgeDraynorDiaryEntry>  medium = getMedium();
		Set<LumbridgeDraynorDiaryEntry>   hard = getHard();
		Set<LumbridgeDraynorDiaryEntry> elite = getElite();
