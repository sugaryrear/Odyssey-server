...
public class QuestTab {
    ...
    public void openTab(Tab tab) {
        //if (!sentDiaries) {
          ...
          //  sentDiaries = true;//is this an issue?
      //  }
    ...
    public void updateInformationTab() {
        //lets just throw it in here for now.

      //  player.getPA().sendFrame126(player.getDisplayName(), 80114);
        player.getPA().sendFrame126("Membership: " + player.getRights().buildCrownString() + " " + player.getRights().getPrimary().toString(), 80113);
