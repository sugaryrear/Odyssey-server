package io.Odyssey.content.titles;
...
public enum Title implements Comparator<Title> {
	...
	GIANT_SLAYER("Badass Slayer", 0, TitleCurrency.NONE, new TitleRequirement() {
	...
	SKILLER("Completionist", 0, TitleCurrency.NONE, new TitleRequirement() {
	...
	MILLIONAIRE("Im rich bitch", 100_000_000, TitleCurrency.COINS, Titles.NO_REQUIREMENT, "To receive access to this title, a player must be a millionaire. Simple.");
