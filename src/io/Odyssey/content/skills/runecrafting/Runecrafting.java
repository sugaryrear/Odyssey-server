...
public class Runecrafting extends SkillHandler {
	...
	public enum RunecraftingData {
		AIR(34760, 556, 5, new int[] { 1, 11, 22, 33, 44, 55, 66, 77, 88, 99 }, 25000, 20667),
		MIND(34761, 558, 5.5, new int[] { 2, 14, 28, 42, 56, 70, 84, 98 }, 24500, 20669),
		WATER(34762, 555, 6, new int[] { 5, 19, 38, 57, 76, 88, 99 }, 24000, 20671),
		MIST(-1, -1, 8, new int[] { 6 }, 15, -1),
		EARTH(34763, 557, 6.5, new int[] { 9, 26, 52, 78, 88, 96 }, 23500, 20673),
		DUST(-1, -1, 8.3, new int[] { 10 }, 15000, -1),
		MUD(-1, -1, 9.3, new int[] { 13 }, 15000, -1),
		FIRE(34764, 554, 7, new int[] { 14, 35, 70, 85, 95 }, 23000, 20665),
		SMOKE(-1, -1, 8.5, new int[] { 15 }, 15000, -1),
		STEAM(-1, -1, 9.3, new int[] { 19 }, 15000, -1),
		BODY(34765, 559, 7.5, new int[] { 20, 46, 75, 92 }, 22500, 20675),
		LAVA(-1, -1, 10, new int[] { 23 }, 15000, -1),
		COSMIC(34766, 564, 8, new int[] { 27, 59, 78 }, 22000, 20677),
		CHAOS(34769, 562, 8.5, new int[] { 35, 74, 86 }, 21500, 20679),
		ASTRAL(34771, 9075, 8.7, new int[] { 40, 82 }, 21000, 20689),
		NATURE(34768, 561, 9, new int[] { 44, 91, 95 }, 20000, 20681),
		LAW(34767, 563, 9.5, new int[] { 54, 79, 93 }, 19500, 20683),
		DEATH(34770, 560, 15, new int[] { 65, 84, 96 }, 19000, 20685),
		BLOOD(43479, 565, 17, new int[] { 77, 89, 94 }, 18800, 20691),
		WRATH(34772, 21880, 15, new int[] { 95 }, 18800, 20691),
		SOUL(34771, 566, 18, new int[] { 90, 95, 99 }, 18000, 20687);
	...
	public static void execute(Player player, int objectId) {
		for (RunecraftingData data : RunecraftingData.values()) {
			...
			if (data.getObjectId() == objectId) {
				...
				if (name.equals("air")) {
					player.getTaskMasterManager().increase(Tasks.CRAFT_AIR_RUNES);
				}
