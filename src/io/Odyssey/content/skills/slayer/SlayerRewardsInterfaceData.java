...
public class SlayerRewardsInterfaceData {
    ...
    public enum Unlock {
        ...
        BROADER_FLETCHING(195_094, 300, SlayerUnlock.BROADER_FLETCHING,
                "Broader Fletching", "Learn to fletch Broad bolts,", "Amethyst broad bolts, and Broad arrows.", "You can buy the (u) broad ammo in the", "Ranging shop to the north."),
        CURSES(195_098, 1000, SlayerUnlock.CURSES,
                "Ancient Curses", "Learn the Ancient Curses", "That can be switched to from the ", "Prayer tab"),
