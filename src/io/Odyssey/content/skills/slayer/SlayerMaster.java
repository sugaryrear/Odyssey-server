...
public class SlayerMaster {
	...
	public static Optional<SlayerMaster> get(int id) {
		...
		//System.out.println("s: "+MASTERS.size());
	...
	//	MASTERS.stream().flatMap(master -> Arrays.stream(master.available)).forEach(child -> System.out.println("child : "+child.getPrimaryName()));
