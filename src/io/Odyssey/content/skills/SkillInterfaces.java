...
//			menuLine("90", "Super Combat \\n Torstol potion (unf), 1 x super attack, strength\\nand defence potion", 12695, 26);
	...
	public void thievingComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("90", "TzHaar-Hur", 21278, 19);
	...
	public void slayerComplex(int screen) {
		if (screen == 1) {
			...
			clearMenu();
			menuLine("1-99", "All of the slayer masters are \\nLocated in the southern part of home island", 4155, 0);
	...
	public void constructionComplex(int screen) {
		if (screen == 1) {
			...
			menuLine("5", "Parlour", 8395, 1);
			menuLine("10", "Kitchen", 8396, 2);
			menuLine("15", "Workshop", 8406, 3);
			menuLine("20", "Bedroom", 8398, 4);
			menuLine("25", "Hall (skill trophies)", 8401, 5);
			menuLine("27", "League hall", 8403, 6);
			menuLine("30", "Games room", 8399, 7);
			menuLine("32", "Combat room", 8400, 8);
			menuLine("35", "Hall (quest trophies)", 8404, 9);
			menuLine("37", "Menagerie", 12725, 10);
			menuLine("40", "Study", 8407, 11);
			menuLine("42", "Costume room", 9842, 12);
			menuLine("45", "Chapel", 8405, 13);
			menuLine("50", "Portal chamber", 8408, 14);
			menuLine("50", "Utilise the Advertisement noticeboard", 21512, 15);
			menuLine("55", "Formal garden", 8416, 16);
			menuLine("60", "Throne room", 8409, 17);
			menuLine("65", "Oubliette", 8410, 18);
			menuLine("65", "Superior garden", 20653, 19);
			menuLine("70", "Dungeon", 8411, 20);
			menuLine("72", "Portal nexus", 22704, 21);
			menuLine("75", "Treasure room", 8414, 22);
			menuLine("80", "Achievement Gallery", 20654, 9);


			optionTab("Construction", "Rooms", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}

		else if (screen == 2) {
			clearMenu();
			menuLine("1", "Clay fireplace", 8325, 0);

			optionTab("Construction", "Skills", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			clearMenu();
			menuLine("1", "Crude Chair", 8309, 0);
			optionTab("Construction", "Surfaces", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Decorative", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Trophies", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Games", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Garden", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Dungeon", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Chapel", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			clearMenu();
			menuLine("30", "Small storage unit", 21037, 0);
			optionTab("Construction", "Raids", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			optionTab("Construction", "Other", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			clearMenu();
			menuLine("20", "Rick", 20243, 0);
			menuLine("25", "Maid", 20243, 1);
			menuLine("30", "Cook", 20243, 2);
			menuLine("40", "Butler", 20243, 3);
			menuLine("50", "Demon butler", 20243, 4);
			optionTab("Construction", "Servants", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
			...
			clearMenu();
			menuLine("1", "Rooms: 24", 2347, 0);
			optionTab("Construction", "House Size", "Rooms","Skills", "Surfaces", "Decorative",
					"Trophies", "Games", "Garden", "Dungeon", "Chapel",
					"Raids", "Other", "Servants", "House Size");
		}
	}
