...
public class BarbarianAgility {
	...
	public boolean barbarianCourse(final Player c, final int objectId) {
		switch (objectId) {
			case 20210:
			//	if(c.absY > 3559){
				if (c.getAgilityHandler().hotSpot(c, 2552,3561)) {
					c.startAnimation(746);
c.setForceMovement(2552, 3558, 0, 100, "SOUTH", 747);//crawl thru
				} else 	if (c.getAgilityHandler().hotSpot(c, 2552,3558)) {
					c.startAnimation(746);
				c.setForceMovement(2552, 3561, 0, 100, "NORTH", 747);//crawl thrue {
