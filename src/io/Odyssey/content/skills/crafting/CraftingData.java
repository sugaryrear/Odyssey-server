...
public class CraftingData extends SkillHandler {
	...
	public enum chargeOrbData {
		...
		AIR(new int[][] { { 2152, 28 } }, 1058, 567, 573, 66, 76, 1, 150, 92),
		FIRE(new int[][] { { 2153, 28 }}, 1056, 567, 569, 62, 73, 1, 152, 91),
		EARTH(new int[][] { { 2150, 28} }, 1054, 567, 575, 58, 70, 1, 151, 90),
		WATER(new int[][] { { 2151, 28 } }, 1051, 567, 571, 54, 66, 1, 149, 89);
