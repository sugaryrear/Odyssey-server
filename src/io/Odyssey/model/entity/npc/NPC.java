...
//		if (getAttackType() == CombatType.MELEE) { // This fixes attacking throough walls - this for npcs that have files associated with them.
//			if (!PathChecker.raycast(this, c, false)) {
//			System.out.println("cant attack you a npcautoattacks npc!");
//				return;
//			}
//		}
		if (NPCHandler.projectileClipping && !npcAutoAttack.isIgnoreProjectileClipping()) {
			if (getAttackType() == null || getAttackType() == CombatType.MAGE || getAttackType() == CombatType.RANGE  || getAttackType() == CombatType.SPECIAL) {
				int x1 = absX;
				int y1 = absY;
				int z = heightLevel;
...
//add npcs that DONT face players here.
	...
	/**
	 *
	 * this is how you make them move, similar to how verzik moves to center.
	 * @param x
	 * @param y
	 * @param run
	 * @param checkClipping
