...
public class AttackAnimation extends NPCHandler {
	...
	public static int handleEmote(NPC npc) {
		if(npc.getNpcId() >= 2450 && npc.getNpcId() <= 2454)
			return 412;
...
//					return 9180;
//				}
			case 11282://nex anim by the plateau
...
//
			...
			case 1472:// jungle demon
				return 64;
			case 1443:
				return npc.getAttackType() == CombatType.MELEE ? 64 : 64;
