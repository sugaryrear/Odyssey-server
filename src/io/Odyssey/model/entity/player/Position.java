...
//		}
		...
		if (Boundary.isIn(this, Boundary.WILDERNESS_UNDERGROUND))
			return true;
		if (Boundary.isIn(this, Boundary.FEROX_ENCLAVE_PARAMETERS))
			return false;
	...
	public boolean inBank() {
		return Area(3071, 3110, 3480, 3514) || Area(3089, 3090, 3492, 3498) || Area(3248, 3258, 3413, 3428)
				...
				|| Boundary.isIn(this, Boundary.HOME_ISLAND);
	}
	...
	@JsonIgnore
	public boolean inDuelArena() {//the area where its "challenge"
        return (x > 1999 && x < 2020 && y > 3675 && y <= 3682)
                || (x > 3311 && x < 3323 && y > 3223 && y < 3248);
    }

	@JsonIgnore
	public boolean inGodwars() {
		return Boundary.isIn(this, Godwars.GODWARS_AREA) || Boundary.isIn(this, Boundary.ZAROSIAN_ENCAMPMENT)  || Boundary.isIn(this, Boundary.NEX);
	}
	...
	public boolean inMulti() {
		if (Boundary.isIn(this, Boundary.ZULRAH)
				...
				|| Boundary.isIn(this, Boundary.TZHAAR_CITY_BOUNDARY)
				...
				|| Boundary.isIn(this, Boundary.ZAROSIAN_ENCAMPMENT)
				|| Boundary.isIn(this, Boundary.WATERBIRTH_CAVES_1)
		|| Boundary.isIn_dontcareh(this, Boundary.WATERBIRTH_CAVES)
...
//			return true;
//		}
		if (Boundary.isIn(this, Boundary.LIGHTHOUSE_DUNGEON)) {
			return true;
		}
