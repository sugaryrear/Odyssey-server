...
public class Boundary {
	...
	public static final Boundary HOME_ISLAND = new Boundary(1922, 3330, 2107, 3853);
	public static final Boundary REVENANT_CAVES = new Boundary(3126, 10044, 3264, 10233);
	public static final Boundary TAVELRY_DUNGEON = new Boundary(2813, 9672, 2969, 9854);
	public static final Boundary FALADOR_MOLE_LAIR = new Boundary(1726, 5120, 1792, 5249);
    /**
	...
	public boolean indontcareh(Entity entity) {
		return isIn(entity, this);
	}
	/**
	...
	public static boolean isIn_dontcareh(Position position, Boundary... boundaries) {
		for (Boundary b : boundaries) {
			if (position.getX() >= b.minX && position.getX() <= b.highX && position.getY() >= b.minY && position.getY() <= b.highY) {
				return true;
			}
	...
	public static boolean isIn(Player player, Boundary boundaries) {
		if (boundaries.height >= 0) {//i mean obv this is an issue - its saying that if you are not in height 0 then ur fucked lol
	...
	public static boolean isIn_dontcareheight(Player player, Boundary boundaries) {
		return player.absX >= boundaries.minX && player.absX <= boundaries.highX && player.absY >= boundaries.minY && player.absY <= boundaries.highY;
	}
	/**
	...
	public static final Boundary TZHAAR_CITY_BOUNDARY = new Boundary(2433, 5063, 2573, 5179);
	...
	public static final Boundary TAVELRY_BLACK_DRAGON_TASK_AREA = new Boundary(2758, 9788, 2865, 9864,1);
	public static final Boundary TAVELRY_BLUE_DRAGON_TASK_AREA = new Boundary(2885, 9791, 2983, 9848,1);
	...
	public static final Boundary HUNLLEF_BOSS_ROOM = new Boundary(1850, 5641, 2051, 5695);
	...
	//3466, 6031, 3635, 6195
	public static final Boundary LONE_SURVIVER_AREA = new Boundary(3466, 6031, 3635, 6195);
	public static final Boundary LONE_SURVIVER = new Boundary(3466, 6031, 3635, 6195);
	public static final Boundary OUTLAST_LOBBY = new Boundary(3321, 4939, 3325, 4979);
	public static final Boundary LONE_SURVIVER_HUT = new Boundary(3137, 3632, 3144, 3638);
...
//3082 3921
	 ...
	 * Kalphite Queen
	 */
	public static final Boundary KALPHITE_QUEEN = new Boundary(3457, 9472, 3514, 9527,0);
	public static final Boundary LIGHTHOUSE_DUNGEON = new Boundary(2492, 4609, 2546, 4667);
	...
	public static final Boundary SKOTIZO_BOSSROOM = new Boundary(2232, 5629, 2307, 5700);
	...
	public static final Boundary NEX = new Boundary(2909, 5188, 2940, 5218);
	...
	public static final Boundary[] GODWARS_BOSSROOMS = {BANDOS_GODWARS, ARMADYL_GODWARS, ZAMORAK_GODWARS, SARADOMIN_GODWARS, NEX};
	...
	public static final Boundary WILDERNESS_UNDERGROUND = new Boundary(2941, 9918, 3137, 10366);
	...
	public static final Boundary[] FEROX_ENCLAVE_PARAMETERS = {FE1,  FE2, FE3};
	...
	public static final Boundary[] DEEP_WILDY_CAVES = {WILDERNESS_GOD_WARS_BOUNDARY, WILDERNESS_UNDERGROUND,VETION_AREA , REV_CAVE};
	...
	public static final Boundary TAVELRY = new Boundary(2878, 3392, 2891, 3400);
	...
	public static final Boundary NEX_ENCAMPMENT = new Boundary(2844, 5184, 2946, 5242);
	public static final Boundary NEX_LOBBY = new Boundary(2901, 5216, 2906, 5224);
	public static final Boundary NexAngelOfDeath = new Boundary(3743, 3974, 3770, 4000);
	public static final Boundary DAGANNOTH_MOTHER_HFTD = new Boundary(2490, 9984, 2549, 10046);
	public static final Boundary MONKEY_MADNESS_DEMON = new Boundary(2625, 4608, 2686, 4670);
	public static final Boundary RFD = new Boundary(1888, 5344, 1911, 5367);

	public static final Boundary RFD_FIGHT_AREA = new Boundary(1873, 5314, 1921, 5378);
	...
	public static final Boundary HUNLLEF_CAVE = new Boundary(1850, 5641, 2051, 5695);
	...
	public static final Boundary[] DUEL_ARENA = {new Boundary(2000, 3684, 2018, 3695), new Boundary(2000, 3684, 2018, 3695)};
	...
	//this is the area where the party interface in grouping tab becomes available
	public static final Boundary RAIDS_LOBBY_ENTRANCE = new Boundary(1220, 3544, 1263, 3578);//was 3027, 6065, 3040, 6072
	//2446, 4643, 2455, 4651
	...
	public static final Boundary OUTSIDE_GWD = new Boundary(2892, 3733, 2940, 3787);
	public static final Boundary LUMB_BASEMENT = new Boundary(3202, 9612, 3230, 9632);
	public static final Boundary GODWARS_MAIN_AREA = new Boundary(2784, 5183, 2969, 5390);
	public static final Boundary SWAMP_AREA = new Boundary(3395, 3163, 3853, 3595);
	public static final Boundary WARRIORS_GUILD = new Boundary(2833, 3531, 2883, 3558);
	...
	public static final Boundary ZAROSIAN_ENCAMPMENT = new Boundary(2845,5195,2909,5225);
