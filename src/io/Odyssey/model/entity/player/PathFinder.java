...
public class PathFinder {
	...
	public void findRouteNoclip(Player c, int destX, int destY, boolean moveNear, int xLength, int yLength) {
		findRoute(c, destX, destY, moveNear, xLength, yLength, true);
	}
