    ...
    public void processPacket(Player c, int packetType, int packetSize) {
        switch (packetType) {
            case EXAMINE_ITEM:
                ...
                c.sendMessage("%s", Server.getWorld().getExamineRepository().item(item));
...
//                }
                NPC npc = NPCHandler.npcs[npcIndex];//c.talkingNpc
                c.sendMessage("%s", Server.getWorld().getExamineRepository().npc(npc.getNpcId()));
