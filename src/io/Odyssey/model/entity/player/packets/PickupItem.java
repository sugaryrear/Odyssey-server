...
public class PickupItem implements PacketType {
    ...
    public void processPacket(final Player c, int packetType, int packetSize) {
        ...
        //c.getDistance(c.itemX ,  c.itemY ) <= 2;
        if (c.getX() == c.itemX && c.getY() == c.itemY || ((c.itemId >= 2412 && c.itemId <= 2414) && c.getDistance(c.itemX , c.itemY ) <= 2 )) {
            pickup(c);
        } else {
