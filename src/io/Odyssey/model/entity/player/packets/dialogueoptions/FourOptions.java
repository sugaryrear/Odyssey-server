...
public class FourOptions {
	...
	public static void handleOption1(Player c) {
		if (c.usingWealth)  //c.getPA().useCharge();
		{

			c.getPA().startTeleport(2532,3856,0, "glory", false);
			c.getPA().useChargeWealth();
			return;
		}
		if (c.usingCombatBracelet)  //c.getPA().useCharge();
		{

			c.getPA().startTeleport(2879,3546,0, "glory", false);
			c.getPA().useChargeCombatBracelet();
			return;
		}
	...
	public static void handleOption2(Player c) {
		if (c.usingWealth)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(3165,3484,0, "glory", false);
			c.getPA().useChargeWealth();
			return;
		}
		if (c.usingCombatBracelet)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(3191,3365,0, "glory", false);
			c.getPA().useChargeCombatBracelet();
			return;
		}
		switch (c.dialogueAction) {
		...
		if (c.dialogueAction == 3301) {
			if (c.npcType == 8623) {//konar slayer
	...
	public static void handleOption3(Player c) {
		if (c.usingWealth)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(2997,3377, 0,"glory", false);
			c.getPA().useChargeWealth();
			return;
		}
		if (c.usingCombatBracelet)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(3052,3491,0, "glory", false);
			c.getPA().useChargeCombatBracelet();
			return;
		}
		switch (c.dialogueAction) {
	...
	public static void handleOption4(Player c) {
		if (c.usingWealth)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(2825,10167,0, "glory", false);
			c.getPA().useChargeWealth();
			return;
		}
		if (c.usingCombatBracelet)  //c.getPA().useCharge();
		{
			...
			c.getPA().startTeleport(2656,3439,0, "glory", false);
			c.getPA().useChargeCombatBracelet();
			return;
		}
		switch (c.dialogueAction) {
