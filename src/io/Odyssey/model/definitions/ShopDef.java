...
public class ShopDef {
            ...
            if (file.isDirectory()) {
                ...
                try {
                    ...
                    shopItems.forEach(item -> {
                        ...
                        items.add(new ShopItem(item.getId() + 1, item.getAmount(), item.getPrice()));                    }); // Item amount is zero for almost all shops due to infinity
    ...
    public int getPrice(int itemId) {//get the price from the yml
