...
//        region.worldObjects.addAll(worldObjects); // need to fix this as causing crashes
    ...
    public Optional<WorldObject> getWorldObject(GlobalObject theobject) {
        final int z = theobject.getHeight();
        return worldObjects.stream().filter(o -> theobject.getObjectId() == o.id && theobject.getX() == o.x && theobject.getHeight() == o.y && theobject.getHeight() == o.height).findFirst();
    }
    /**
...
//        //System.out.println("anything? :"+objectId);
//        if(objectId == -1){
////if(type == 0){
////    setClippingForVariableObject(objectId,x, y, height, type, direction, true);
////
...
//            } else if (type >= 9) {
//              //  if (def.aBoolean767()) {
//                    removeClippingForSolidObject(x, y, height, 1, 1, false);//todo: somehow pass the xlength and ylength
//                   // if (def.aBoolean757) {
//                        removeProjectileClippingForSolidObject(x, y, height, 1, 1, true);
//                   // }
//             //   }
...
//        }
    ...
    public void addObject(int objectId, int x, int y, int height, int type, int direction) {
        ...
        if (type == 22) {
            ...
            if (def.aBoolean767()) {//if its solid
               addClippingForSolidObject(x, y, height, xLength, yLength, def.solid());
                if (def.aBoolean757) {//if its impenetrable
            ...
            if (def.aBoolean767()) {//if its solid
                setClippingForVariableObject(objectId,x, y, height, type, direction,  false);
                if (def.aBoolean757) {//if its impenetrable ( means you CANT  shoot through it)
...
//                if(regionIds[i] == 6727) {
//
//                    System.out.println("do we yes mind altar. and i: "+i+" map: "+mapGroundFileIds[i]+" and obj: "+mapObjectsFileIds[i]);
//                }

                data[i] = new RegionData(regionIds[i], mapGroundFileIds[i], mapObjectsFileIds[i]);
            }
        //   data[515] = new RegionData(7993,7116,7117);//bottom part - actually 2556,2557
     //     data[514] = new RegionData(7992,7100,7101);//top part  actually 2028, 2029
       data[462] = new RegionData(7737,7102,7103);//where the magic happens ;) - nw part, 798, 799
            data[562] = new RegionData(8247,7104,7105);//where the magic happens ;) - slayer part, 1023,1024
            data[564] = new RegionData(8249,7110,7111);//where the magic happens ;) - right part,
            data[563] = new RegionData(8248,7112,7113);//where the magic happens ;) - right part,
            data[1175] = new RegionData(11083,7114,7115);//mind altar?
...
//    System.out.println("map: "+mapGroundFileIds[i]);
    ...
    public static Map<Integer,String> regionnames  = new HashMap<>();
    public static ArrayList<Position> molehills  = new ArrayList<>();


    static {
        regionnames.put(7992, "Home Island");
        regionnames.put(10042, "Waterbirth Island");
        regionnames.put(10553, "Rellekka");
        regionnames.put(13623, "Slayer Tower");
        regionnames.put(11573, "Tavelry");
        regionnames.put(11578, "God Wars Dungeon");
        regionnames.put(14135, "Fenkenstrain's Castle");
        regionnames.put(6223, "Lithkren Vault");
        regionnames.put(10057, "Mage Bank");
        regionnames.put(11319, "Warrior's Guild");
        regionnames.put(9808, "Tzhaar City");
        regionnames.put(13972, "Kalphite Lair");
        regionnames.put(6993, "Mole Lair");
        regionnames.put(11828, "Falador");
        regionnames.put(12853, "Varrock");
        regionnames.put(13106, "Al Kharid");
        regionnames.put(11062, "Camelot");
        regionnames.put(11317, "Catherby");
        regionnames.put(10547, "Ardougne");
        regionnames.put(9033, "King Black Dragon Lair");
        regionnames.put(9808, "Tzhaar City");
        regionnames.put(10288, "Yanille");
        regionnames.put(12600, "Ferox Enclave");
        regionnames.put(13099, "Sophanem");
        regionnames.put(12342, "Edgeville");
        regionnames.put(11051, "Ape Atoll");
        regionnames.put(12895, "Priffdinas");
        regionnames.put(12082, "Port Sarim");
        regionnames.put(9797, "Zanaris");
        regionnames.put(12341, "Barbarian Village");
        regionnames.put(11310, "Shilo Village");
        regionnames.put(13878, "Canifis");
        regionnames.put(14131, "Barrows");
        regionnames.put(9023, "Ungael");
        regionnames.put(9116, "Kraken Cove");
        regionnames.put(13727, "Silk Chasm");
        regionnames.put(13473, "Callisto's Den");
        regionnames.put(12441, "Obor's Lair");
        regionnames.put(12955, "Bryophyta's Lair");
        regionnames.put(10537, "Void Knight Outpost");
        //mole lair lol just add it here for now who gives a fuck as long as its loaded statically
        molehills.add( new Position(2999,3375,0));
        molehills.add( new Position(2996,3377,0));
        molehills.add( new Position(2989,3378,0));
        molehills.add( new Position(2987,3387,0));
        molehills.add( new Position(2984,3387,0));
        molehills.add( new Position(3005,3376,0));
...
//what loads the map
    private static void loadMap(RegionData regionData) {
     ...
     //   System.out.println("cu: "+customMapFiles);
    ...
    private static void loadMaps(int regionId, ByteStream str1, ByteStream str2) {//aka readtile
...
//slayer tower
          //  new WorldObject(-1,3434,3537, 0, 3),
          //  new WorldObject(2031,  2048,3660, 0, 2),
        //    new WorldObject(2030,  2054,3655, 0, 2),

         //  new WorldObject(2119,  3434,3537, 0, 3),
           // new WorldObject(2120,  3434,3537, 1, 3),

           // new WorldObject(-1,2907,9698, 0, 0),
          //  new WorldObject(-1,2908,9698, 0, 0),

         //   new WorldObject(20377, 3554, 9714, 0, 3),

            new WorldObject(23145, 2474, 3435, 0, 0),
            new WorldObject(30282, 2496,5126, 0, 0),


            //barrows staircases
//            new WorldObject(20668, 3557,9718, 3, 1),
//            new WorldObject(20672, 3578,9703, 3, 2),
//            new WorldObject(20671, 3565,9683, 3, 3),
//            new WorldObject(20670, 3546,9685, 3, 0),
//            new WorldObject(20667, 3558,9703, 3, 1),
...
//    new WorldObject(9030, 3190, 3929, 0, 1), new WorldObject(9030, 3191, 3930, 0, 1), new WorldObject(9030, 3190, 3931, 0, 1),
    ...
    // Barrows
  //  new WorldObject(20973, 3551, 9695, 0, 0),


//            new WorldObject(46277, 3558, 9703, 3, 1),//ahrim
//            new WorldObject(46277, 3557, 9718, 3, 1),//dharok
//            new WorldObject(46277, 3578, 9703, 3,2),//verac
//            new WorldObject(46277, 3565, 9683, 3,3),//torag
//            new WorldObject(46277, 3546, 9685, 3,0),//karil
//            new WorldObject(46277,  3534, 9705, 3,0),//guthan


         //   new WorldObject(20720,  3554, 9714, 3,3),//guthan sarcophagus


         new WorldObject(3610,  3550, 9694, 0,0),//rope near barrowsc hest
...
//    new WorldObject(11373, 2943, 3282, 0, 1),  //Mith
 ...
 //   new WorldObject(10834, 2853, 2980, 0, 0), new WorldObject(10834, 2853, 2983, 0, 0), new WorldObject(10834, 2853, 2986, 0, 0), new WorldObject(10834, 2853, 2989, 0, 0),
  ...
  //  new WorldObject(10822, 2842, 2980, 0, 0), new WorldObject(10822, 2842, 2983, 0, 0), new WorldObject(10822, 2842, 2986, 0, 0), new WorldObject(10822, 2842, 2989, 0, 0)
    ...
    private void setClippingForVariableObject(int objectId, int x, int y, int height, int type, int direction, boolean negative) {
        if (type == 0) {
