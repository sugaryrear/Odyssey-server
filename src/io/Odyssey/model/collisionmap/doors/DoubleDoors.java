...
public class DoubleDoors {
    ...
    public static DoubleDoors getSingleton() {
        if (singleton == null) {
            singleton = new DoubleDoors("./etc/cfg/doors/doubledoors.txt");
        }
        return singleton;
    }
    ...
    public boolean handleDoor( int id, int x, int y, int z) {
        ...
        if (doorClicked.open == 0) {
            if (doorClicked.originalFace == 0) {
                ...
                DoubleDoors lowerDoor = getDoor(id - 1, x, y +1, z);
                DoubleDoors upperDoor = getDoor(id + 1, x, y -1, z);
                if (lowerDoor != null) {
                    changeLeftDoor(lowerDoor);
                    changeRightDoor(doorClicked);
                } else if (upperDoor != null) {
                ...
                DoubleDoors westDoor = getDoor(id + 3, x -1, y, z);
                DoubleDoors eastDoor = getDoor(id - 3, x +1, y, z);
                if (westDoor != null) {//this happens when you click on the east door
                    changeLeftDoor(westDoor);
                    changeRightDoor(doorClicked);
                } else if (eastDoor != null) {//this happens when you click on the west door
                    changeLeftDoor(doorClicked);
                    changeRightDoor(eastDoor);
                }
            }
            ...
            if (doorClicked.originalFace == 0) {
                ...
                DoubleDoors westDoor = getDoor(id - 1, x -1, y, z);
                DoubleDoors eastDoor = getDoor(id + 1, x, y -1, z);
                if (westDoor != null) {
                    changeLeftDoor(westDoor);
                    changeRightDoor(doorClicked);
                } else if (eastDoor != null) {
                ...
                DoubleDoors northDoor = getDoor(id - 1, x, y + 1, z);
                DoubleDoors southDoor = getDoor(id + 1, x, y -1, z);
                if (northDoor != null) {
                    changeLeftDoor(northDoor);
                    changeRightDoor(doorClicked);
                } else if (southDoor != null) {
