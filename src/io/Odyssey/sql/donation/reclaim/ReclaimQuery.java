...
public class ReclaimQuery implements SqlQuery<ReclaimDonationResponse> {
    ...
    public static int getV1DonationDollars(Connection connection, String oldAccountUsername) throws SQLException {
        ...
        select.setTimestamp(3, Timestamp.valueOf(Configuration.Odyssey_V2_LAUNCH_DATE.atStartOfDay()));
        select.setTimestamp(4, Timestamp.valueOf(Configuration.Odyssey_V1_LAUNCH_DATE.atStartOfDay()));
